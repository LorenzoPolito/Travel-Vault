...
- **Budget stimato**: ~2.856 €/persona (voli inclusi 1.096 €)
- **Stato**: ✅ **VOLI PRENOTATI** (China Eastern open-jaw, 09/08/26) · ✅ **Alloggi prenotati** · 🔵 **USJ PRENOTATO (05/09/26)** · ❌ attività da prenotare (TeamLab, JR Kansai-Hiroshima Pass, eSIM, assicurazione)
