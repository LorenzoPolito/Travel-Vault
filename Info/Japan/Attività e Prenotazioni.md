...
## 🗓️ Quando prenotare — finestre (ricerca 09/09/2026)

> Regola d'oro: **prenotare appena la finestra apre**. Finestre JR → **1 mese prima, 10:00 JST**; Skytree ~30 giorni (00:00 JST); Shibuya Sky → **14 giorni** (00:00 JST); Puroland/Museo Pace già in vendita. ⏰ JST = **+7h sull'Italia fino al 25 ott** (poi +8h).
...
| 5 | Uzumasa Kyoto Village (EVA) | 31 Ott | vendita con ampio anticipo (calendario JS) | 🟡 **appena disponibile** | ticket.eigamura.com | ¥2.800 (1day) |
...
| Voce | Costo | Copre | Note |
|---|---|---|---|
| Pass 5 giorni | **17.000 ¥** (~92 €) | Shinkansen Shin-Osaka⇔Hiroshima A/R (posti riservati), traghetto JR Miyajima, linee JR West (incl. Nara→Kyoto) | Valido **28 ott – 1 nov** · acquistare su **JR-WEST ONLINE TRAIN RESERVATION** per prenotare i posti online dal 28 Set (Klook = solo ritiro in stazione + posti in loco) |

> Il **JR Pass nazionale NON conviene**. Restano fuori dal pass: Osaka→Nara (Kintetsu, ~¥570, non-JR) e Kyoto→Tokyo (biglietto singolo sotto).

## Kyoto → Tokyo Shinkansen (Domenica 1 Nov)

| Voce | Costo/persona | Note |
|---|---|---|
| Hikari, **posto riservato** | ~13.650 ¥ (~74 €) | **SmartEX** (app/web): finestra dal **1 Ott 10:00 JST** · sconto Hayatoku 21 se prenotato entro 11 Ott |

## Ingressi templi, musei e torri (allineati all'itinerario)
...
| Itsukushima Shrine (Miyajima) | ¥300 | 5 | 28 Ott |
| Tempio Todaiji (Nara) | ¥800 | 6 | 29 Ott |
| Kiyomizu-dera | ¥500 | 7 | 30 Ott |
...
| Shibuya Sky *(opzionale)* | web ¥2.700 (10:00–14:59) / **¥3.400 dalle 15:00** | 12 | 4 Nov |
| Tokyo Tower | ¥1.500 | 13 | 5 Nov |
...
> - **Tokyo Skytree** → sito ufficiale `tokyo-skytree.jp` (online ~¥2.100–2.300; finestra ~30gg) o Klook
> - **Shibuya Sky** → `shibuya-sky.com` (**finestra 14 giorni, 00:00 JST**) — ¥2.700 entro le 15:00, **¥3.400 dopo** (slot tramonto)
> - **Tokyo Tower** → sito ufficiale `tokyotower.co.jp` (Main Deck **¥1.500**, stesso prezzo in cassa)
> - **Uzumasa Kyoto Village** → `ticket.eigamura.com` (¥2.800, EVA inclusa)
> - **Museo della Pace di Hiroshima** → Klook/Asoview (¥200, slot 30', finestra 90 gg)
