...
tags:
  ...
  - consuntivo
  - tracking
ai_role: "Consuntivo spese reali del viaggio Giappone 2026. Tabelle da compilare manualmente (prenotazioni + registro giornaliero + riepilogo)."
---

# 💶 Spese Reali — Giappone 23 Ott – 6 Nov 2026

> Consuntivo **manuale**. Aggiungi ogni spesa appena la fai.
> 💱 Tasso di riferimento: **~184 ¥/€** (aggiorna se cambia) · 👥 Persone: Lorenzo, Davide, Rebecca.
> Colonne: **Importo** (numero) · **Valuta** (¥ o €) · **Importo €** (convertito) · **Pagato da** · **Diviso tra** (es. `3` o `L,D,R`).

---

## 1) Spese pre-partenza / prenotazioni

| Voce                              | Categoria     |      Data |  Importo | Valuta | Importo/pax € | Pagato da | Diviso tra | Stato       |
| --------------------------------- | ------------- | --------: | -------: | ------ | ------------: | --------- | ---------- | ----------- |
| Volo A/R China Eastern            | Voli          |  09/08/26 | 1.096,33 | €      |      1.096,33 |           | 3          | ✅ Pagato    |
| Alloggio Izumisano (KURA)         | Alloggio      |           |          | €      |         26,67 |           | 3          | ✅           |
| Alloggio Osaka (Hanazonocho)      | Alloggio      |           |          | €      |         74,33 |           | 3          | ✅           |
| Alloggio Kyoto (Miro Nijo)        | Alloggio      |           |          | €      |         85,72 |           | 3          | ✅           |
| Alloggio Tokyo (Taito Guesthouse) | Alloggio      |           |          | €      |        173,17 |           | 3          | ✅           |
...
| Shibuya Sky                       | Attività      |  21/10/26 |    3.400 | ¥      |         18,48 |           | 3          | ❌ Da fare   |
| Museo della Pace Hiroshima        | Attività      |           |      200 | ¥      |          1,09 |           | 3          | ❌ Da fare   |
| Bagagli Takkyubin Osaka→Tokyo     | Extra         |  29/10/26 |    3.160 | ¥      |         17,17 |           | 1          | ❌ Da fare   |
| eSIM                              | eSIM          |           |       20 | €      |         20,00 |           | 1          | ❌ Da fare   |
|                                   |               |           |          |        |               |           |            |             |

---

## 2) Registro spese in viaggio (giornaliero)

| Data | Giorno | Categoria | Descrizione | Importo | Valuta | Importo € | Pagato da | Diviso tra | Note |
|---|---|---|---|---:|---|---:|---|---|---|
| 24/10 | G1 |  |  |  |  |  |  |  |  |
| 25/10 | G2 |  |  |  |  |  |  |  |  |
| 26/10 | G3 |  |  |  |  |  |  |  |  |
...
> Categorie suggerite: **Cibo · Trasporti · Ingressi/Attività · Souvenir · Extra · Alloggio**.

---

## 3) Riepilogo per categoria

| Categoria | Budget (stima €) | Speso reale € | Delta € | Note |
| --- | ---: | ---: | ---: | --- |
...
## 4) Saldo tra noi (chi ha anticipato per gli altri)

| Persona | Ha anticipato € | Dovuto (quota) € | Saldo € |
| ------- | --------------: | ---------------: | ------: |
| Lorenzo |                 |                  |         |
| Davide  |                 |                  |         |
| Rebecca |                 |                  |         |

> Alla fine: chi ha anticipato più del dovuto riceve la differenza dagli altri.

---

## 5) Budget Tracker (stime — spostato dall'itinerario)

| Voce | Stima | Reale | Note |
| --- | --- | --- | --- |
...
## Come compilare (promemoria)

1. Ogni spesa → riga nel **Registro** (o sezione 1 se prenotazione).
2. Importo in **¥** o **€**: se ¥, converti con il tasso e scrivi il valore in **Importo €**.
3. `Pagato da` = chi mette i soldi; `Diviso tra` = `3` (tutti) o `1` (personale) o nomi.
4. A fine viaggio somma per categoria e confronta col **Budget** (sez. 3) → poi salda (sez. 4).
5. I totali si possono sommare a mano o con formule TBLFM di Obsidian.
