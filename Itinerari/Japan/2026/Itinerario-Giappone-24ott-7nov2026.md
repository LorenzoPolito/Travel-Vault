...
budget_totale_stimato: "2.440-2.640 €/persona"
tags:
  - itinerario
  - japan
  - "2026"
...
flowchart LR
    ...
    B --> C[🏙️ Osaka 3 notti]
    C -->|Shinkansen 1.5h| D[🕊️ Hiroshima day trip]
    D --> C
...
gantt
    ...
    Shibuya + Shinjuku     :2026-11-03, 1d
    🏔️ Fujiyoshida          :2026-11-04, 1d
    Nakano + TeamLab       :2026-11-05, 1d
...
xychart-beta
    ...
    y-axis "€" 0 --> 140
    bar [0,37,53,90,28,47,56,58,133,58,57,50,62,92,30]
```
...
| 13 Lug | ✅ | **Da €290** (stima Rome2Rio) — China Eastern via PVG · Finnair via HEL · ITA/ANA via TYO — tutte sotto 21h. **Google Flights non mostra one-way per questa tratta** | **€601 reale** 🏆 — Qatar Airways via DOH (HND→FCO, 20h05m, ✅ under 21h) · **€664** Asiana via ICN (NRT→FCO, 18h35m) · **€740** Emirates via DXB (HND→FCO) | **~€900+** | Fonte: [Google Flights TYO→FCO 6 Nov](https://www.google.com/travel/flights?q=flights+from+tokyo+to+rome+on+2026-11-06+one+way) — Qatar €601 **reale** per il ritorno. Andata da verificare su trip.com |
| 15 Lug | ⬜ | — | — | — | — |
| 17 Lug | ⬜ | — | — | — | — |
| 19 Lug | ⬜ | — | — | — | — |
| 21 Lug | ⬜ | — | — | — | — |
