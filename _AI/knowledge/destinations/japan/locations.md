...
source_files:
  - Locations/Japan/Lista dei Luoghi.md
  - Locations/Japan/Cities/
  - Locations/Japan/Temples/
  - Locations/Japan/Parks-nature/
...
> Quando aggiungi una nuova location al vault (`Locations/Japan/<categoria>/`), aggiorna la sezione corrispondente in questo file e aggiorna `total_locations` nel frontmatter.

---

## Fonte Master

`Locations/Japan/Lista dei Luoghi.md` — master list con voti `#X/5` e cluster `//`

---

## Sistema di Punteggio e Cluster

- `#X/5` = priorità/interesse (5=imperdibile, 1=bassa priorità)
- Il separatore `//` in Obsidian = cambio **cluster geografico** (gruppo di luoghi entro ~30min a piedi/metro)
- La numerazione in lista è per punteggio, non per distanza
...
### Miyajima (isola, traghetto 10min da Miyajimaguchi)

- Itsukushima Shrine / Torii Galleggiante `#5/5` ⚠️ Verificare orari maree
...
- Quartiere Gion `#1/5` ⚠️ *Vicoli privati vietati ai turisti (multa 70€), no foto/video Geisha*
...
- Arashiyama (24H) `#5/5` — [Trekking 3h wikiloc](https://www.wikiloc.com/hiking-trails/japan-arashiyama-31188930)
...
- Mario Kart Ride (~100€, patente richiesta, 10:00-22:00) `#2/5`
- Golden Gai `#2/5`
- Harajuku `#2/5`

**Cluster 4 — Nakano:**
- Nakano + Nakano Broadway `#5/5` *(anime/manga vintage — Lorenzo)*
- The Making of Harry Potter (8:30-18:30) `#1/5` *(Damiano — prenotare mesi prima)*
